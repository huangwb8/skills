...
Version 2.1.4 adds business-evidence hash and reference bindings: Kernel-computed Gates lock the evidence index content, transitions validate the same run identity and evidence binding, and read-only APIs expose the original Verifier/Gate receipts.
...
- [Gitee mirror](https://gitee.com/huangwb8/skills): If GitHub is inconvenient to access, you can also get this project from the Gitee mirror.
