...
def run_draw_plot(
    *,
    ...
    manifest["image_provider"] = {
        ...
        "config_path": str(provider_cfg.config_path) if provider_cfg.config_path else None,
        "auth_path": str(provider_cfg.auth_path) if provider_cfg.auth_path else None,
        "api_key_fingerprint": provider_cfg.api_key_fingerprint,
        "config_conflicts": list(provider_cfg.config_conflicts),
