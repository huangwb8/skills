...
> 状态更新（2026-09-20）：本计划关于“所有新项目强制 targets”的结论已由
> [`2026-09-20-bensz-rmd-rules-双模式与轻量测试优化计划.md`](2026-09-20-bensz-rmd-rules-双模式与轻量测试优化计划.md)
> 的 simple/complex 分流取代。`renv` 仍是所有新项目的环境底线；已有项目不自动迁移、
> 不补齐缺失机制、旧 runner 不作为新项目回退入口、固定依赖收缩等结论继续有效。
