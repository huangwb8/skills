...
**本技能严格遵循"当前文件夹隔离"原则**，确保操作安全可控：

### ✅ 允许的操作
- 在当前工作目录内创建/修改文件（AGENTS.md、CLAUDE.md、README.md 等）
- 只读访问当前目录的现有文件（提取项目信息）
- 扫描当前目录结构（检测项目类型）
...
### 🛡️ 安全机制
- 脚本启动时自动验证输出目录是否在当前工作目录内
- 如果检测到尝试访问当前目录之外的路径，会立即终止并显示警告
- 所有文件操作使用相对路径，确保限定在当前目录
