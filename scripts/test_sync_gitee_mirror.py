...
def test_normalize_repo_accepts_owner_repo_and_urls():
    assert sync_script.normalize_repo("huangwb8/skills") == "huangwb8/skills"
    assert (
        sync_script.normalize_repo("https://gitee.com/huangwb8/skills.git")
        == "huangwb8/skills"
    )
    assert (
        sync_script.normalize_repo("git@gitee.com:huangwb8/skills.git")
        == "huangwb8/skills"
    )
...
def test_build_gitee_remote_url_uses_ssh_transport():
    assert (
        sync_script.build_gitee_remote_url("huangwb8/skills")
        == "git@gitee.com:huangwb8/skills.git"
    )
